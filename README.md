...
Expected runtime: ~2 min per scenario on the experimental machine (Intel Xeon @ 2.20 GHz, 4 vCPUs, 16 GB RAM), parallelized across 4 workers. Full 23-scenario suite completes in ~35 min.
